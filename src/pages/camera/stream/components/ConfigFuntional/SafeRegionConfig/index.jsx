...
import styles from './SafeRegionConfig.module.scss';
import LayerComponent from '../LayerComponent';
import FlvPlayer from '../../../stream_flv/FlvPlayer';

const cx = classNames.bind(styles);

export default function SafeRegionConfig() {
    ...
    ] = useSelector(({ loading: { effects }, safeRegionConfig }) => [effects, safeRegionConfig]);
    ...
    const onChangeDate = (value, key) => {
        ...
        dispatch({
            type: 'safeRegionConfig/UPDATE_CONFIG_TIME',
            payload: {
                [key]: value,
            },
        });
    ...
    const handleSaveConfig = () => {
        dispatch({
            type: 'safeRegionConfig/UPDATE_CONFIG_TO_DB',
            payload: {
                ...params,
                jobs_cam: {
                    safe_area_regions: {
    ...
    const onLoad = () => {
        dispatch({
            type: 'safeRegionConfig/GET_CURRENT_CONFIG',
            payload: {
                ...params,
            },
        });
    ...
    function showStatus() {
        if (!statusProcess || statusProcess === 'NOT_RUN') {
            return 'Chức năng vùng an toàn chưa chạy trên camera. Bạn có thể bấm start để chạy';
        }
        return 'Chức năng vùng an toàn đang chạy trên camera. Bạn có thể bấm stop rồi start để chạy lại';
    }
    ...
    const handleOk = () => {
        ...
        // update lại store
        dispatch({
            type: 'safeRegionConfig/UPDATE_CONFIG_COORDINARITE',
            payload: {
                coordinates: coordItems,
            },
        });
            ...
            <Modal
                ...
                footer={[
                    ...
                    <Button
                        ...
                        type="primary"
                        onClick={handleOk}
                        loading={loading['safeRegionConfig/UPDATE_CONFIG_TO_DB']}
                    >
                        Hoàn tất vẽ
                    </Button>,
            ...
            <Row className={cx('wraper__status')}>
                ...
                <Col span={4}>
                    <Button
                        ...
                        loading={loading['safeRegionConfig/START']}
                    >
                        Start
                    </Button>
                </Col>
                <Col span={4}>
                    <Button
                        ...
                        loading={loading['safeRegionConfig/STOP']}
                    >
                        Stop
                    </Button>
                </Col>
                ...
                <Row>
                    <Col>
                        <div className={cx('wraper__form__config_time')}>
                            <p> Khoảng thời gian vào vùng nguy hiểm (giây)</p>
                            <InputNumber
                                className="ml50"
                                placeholder="Nhập"
                                min={0}
