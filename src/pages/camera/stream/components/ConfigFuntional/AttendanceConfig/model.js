    ...
    effects: {
        *GET_CURRENT_CONFIG({ payload }, saga) {
            try {
                ...
                console.log('response GET_CURRENT_CONFIG attendanceConfig: ', response);
                yield saga.put({
                    type: 'SET_DATA',
        ...
        *UPDATE_CONFIG_TO_DB({ payload, callback }, saga) {
        ...
        // Using when thay đổi thời gian bắt đầu và kết thúc điểm danh
