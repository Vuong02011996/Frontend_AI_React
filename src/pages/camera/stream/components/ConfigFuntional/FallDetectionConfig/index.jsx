...
import styles from './FallDetectionConfig.module.scss';
import LayerComponent from '../LayerComponent';
import FlvPlayer from '../../../stream_flv/FlvPlayer';

const cx = classNames.bind(styles);

export default function FallDetectionConfig() {
    ...
    ] = useSelector(({ loading: { effects }, fallDetectionConfig }) => [effects, fallDetectionConfig]);
    ...
    const onChangeDate = (value, key) => {
        ...
        dispatch({
            type: 'fallDetectionConfig/UPDATE_CONFIG_TIME',
            payload: {
                [key]: value,
            },
        });
    ...
    const handleSaveConfig = () => {
        dispatch({
            type: 'fallDetectionConfig/UPDATE_CONFIG_TO_DB',
            payload: {
                ...params,
                jobs_cam: {
                    fall_detection: {
    ...
    const startRollCall = () => {
        dispatch({
            type: 'fallDetectionConfig/START',
            payload: {
                id: params.id,
            },
            callback: (response) => {
    ...
    const onLoad = () => {
        dispatch({
            type: 'fallDetectionConfig/GET_CURRENT_CONFIG',
            payload: {
                ...params,
            },
        });
    ...
    function showStatus() {
        if (!statusProcess || statusProcess === 'NOT_RUN') {
            return 'Chức năng phát hiện té ngã chưa chạy trên camera. Bạn có thể bấm start để chạy';
        }
        return 'Chức năng phát hiện té ngã đang chạy trên camera. Bạn có thể bấm stop rồi start để chạy lại';
    }
    ...
    const handleOk = () => {
        ...
        // update lại store
        dispatch({
            type: 'fallDetectionConfig/UPDATE_CONFIG_COORDINARITE',
            payload: {
                coordinates: coordItems,
            },
        });
            ...
            <Modal
                ...
                footer={[
                    ...
                    <Button
                        ...
                        type="primary"
                        onClick={handleOk}
                        loading={loading['fallDetectionConfig/UPDATE_CONFIG_TO_DB']}
                    >
                        Hoàn tất vẽ
                    </Button>,
            ...
            <Row className={cx('wraper__status')}>
                ...
                <Col span={4}>
                    <Button
                        ...
                        loading={loading['fallDetectionConfig/START']}
                    >
                        Start
                    </Button>
                </Col>
                <Col span={4}>
                    <Button
                        ...
                        loading={loading['fallDetectionConfig/STOP']}
                    >
                        Stop
                    </Button>
                </Col>
