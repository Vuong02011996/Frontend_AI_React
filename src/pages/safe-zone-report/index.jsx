...
const Index = memo(() => {
    const [{ effects }, { data, classes, branches, error, pagination }] = useSelector(({ loading, safeRegions }) => [
        loading,
        safeRegions,
    ]);
    ...
    const columns = [
        ...
        },
        {
            ...
            width: '150',
            className: 'min-width-250',
            render: (record) => <img src={record.image_person_url} alt="anh vung an toan" />,
        },
                ...
                <Pane className="card mt20">
                    <Pane className="p20">
                        ...
                        <Table
                            columns={columns}
                            dataSource={data}
                            loading={effects['safeRegions/GET_DATA']}
