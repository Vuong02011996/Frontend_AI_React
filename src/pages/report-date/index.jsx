...
const Index = memo(() => {
  ...
  ] = useSelector(({ loading: { effects }, reportDate }) => [effects, reportDate]);
        ...
        <Pane className="card mt20">
          <Pane className="p20">
            ...
            <Table
              columns={columns}
              dataSource={data}
              loading={loading['reportDate/GET_DATA']}
